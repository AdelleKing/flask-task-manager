...
def register():
    if request.method == "POST":
        # check if username already exists within the db
...
def login():
    if request.method == "POST":
        ...
        if exisiting_user:
        #need to check if the hashed password matches the user input
...
def profile(username):
    #getting the users username from the database
